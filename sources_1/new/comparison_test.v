...
// -------------------------------------------------------------------
// 对比测试模块
// 1.支持源端50MHz、125MHz、200MHz速率对比实验
// 2.支持有无FIFO反压对比实验(200MHz)
// -------------------------------------------------------------------
...
module comparison_test(
    ...
    parameter  DATA_LENGTH     = 32'd524_288_000;         // 数据总长度:500MB
    parameter  UDP_SEND_LENGTH = 16'd1472;                // UDP触发发送长度（满速率测试）
